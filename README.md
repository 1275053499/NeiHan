...
9.14日提示：针对朋友们提出的首页的崩溃问题，大家可以在NHHomeTableViewCellFrame.m文件的233行之后加上这句判断。然后重新运行一下。
因为我这边也没有定位到问题，是个别朋友给我提出的，加个错误处理，希望能解决此bug
github上的代码暂时不更新了，为了保留快速高仿开发的真实性，谢谢。
